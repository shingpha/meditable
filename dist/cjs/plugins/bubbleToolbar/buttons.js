...
var format = require('../../modules/content/commands/format.js');
...
function formatsForBlock(block, start, end) {
    const tokens = index.tokenizer(block.text ?? '');
    return format.getFormatsInRange({ offset: start }, { offset: end }, tokens).formats;
}
...
exports.BLACKLIST_BLOCK_TYPES = BLACKLIST_BLOCK_TYPES;
