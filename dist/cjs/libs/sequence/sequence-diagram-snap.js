...
Diagram.prototype.getActor = function (alias, name) {
  ...
  i = actors.push(new DiagramActor(alias, name || alias, actors.length));
  return actors[i - 1];
};
...
function DiagramActor(alias, name, index) {
  this.alias = alias;
  this.name = name;
  this.index = index;
}
function DiagramSignal(actorA, signaltype, actorB, message) {
  this.type = 'Signal';
  this.actorA = actorA;
  this.actorB = actorB;
...
DiagramSignal.prototype.isSelf = function () {
  return this.actorA.index == this.actorB.index;
};
function DiagramNote(actor, placement, message) {
  this.type = 'Note';
  this.actor = actor;
...
DiagramNote.prototype.hasManyActors = function () {
...
const parser = function () {
  ...
  const parser = {
    ...
    performAction: function (yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      ...
      switch (yystate) {
        ...
        case 9:
          ...
          break;
        case 10:
          this.$ = new DiagramNote($$[$0 - 1], $$[$0 - 2], $$[$0]);
          break;
        case 11:
          this.$ = new DiagramNote($$[$0 - 1], Diagram.PLACEMENT.OVER, $$[$0]);
          break;
        case 12:
        case 20:
          this.$ = $$[$0];
        ...
        case 15:
          ...
          break;
        case 16:
          this.$ = new DiagramSignal($$[$0 - 3], $$[$0 - 2], $$[$0 - 1], $$[$0]);
          break;
        case 17:
    ...
    parse: function (input) {
      function lex() {
        let token;
        return token = lexer.lex() || EOF, typeof token !== 'number' && (token = self.symbols_[token] || token), token;
      }
      var self = this;
      let stack = [0];
      let vstack = [null];
      ...
      lexer.setInput(input, sharedState.yy), sharedState.yy.lexer = lexer, sharedState.yy.parser = this, typeof lexer.yylloc === 'undefined' && (lexer.yylloc = {});
      ...
      for (var symbol, preErrorSymbol, state, action, r, p, len, newState, expected, yyval = {};;) {
        ...
        switch (action[0]) {
          case 1:
            stack.push(symbol), vstack.push(lexer.yytext), lstack.push(lexer.yylloc), stack.push(action[1]), symbol = null, preErrorSymbol ? (symbol = preErrorSymbol, preErrorSymbol = null) : (yyleng = lexer.yyleng, yytext = lexer.yytext, yylineno = lexer.yylineno, yyloc = lexer.yylloc, recovering > 0 );
            break;
          case 2:
            ...
            }, ranges && (yyval._$.range = [lstack[lstack.length - (len || 1)].range[0], lstack[lstack.length - 1].range[1]]), r = this.performAction.apply(yyval, [yytext, yyleng, yylineno, sharedState.yy, action[1], vstack, lstack].concat(args)), typeof r !== 'undefined') return r;
...
function wobble(x1, y1, x2, y2) {
  ...
  return 'C' + p1.x.toFixed(1) + ',' + p1.y.toFixed(1) +
  // start control point
