...
function svgToBlob(svg, scale, fillColor) {
    return new Promise((resolve) => {
        ...
        const canvas = document.createElement('canvas');
        const ctx = canvas.getContext('2d');
        img.src = `data:image/svg+xml;base64,${jsBase64.Base64.encode(svg)}`;
        img.onload = () => {
...
function svgToDataURI(svg) {
    return `data:image/svg+xml;base64,${jsBase64.Base64.encode(svg)}`;
}
...
exports.imgURLToBlob = imgURLToBlob;
exports.removeSVGUse = removeSVGUse;
