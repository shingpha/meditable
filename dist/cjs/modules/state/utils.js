...
var rules = require('../content/inlineRenderers/tokenizer/rules.js');
...
function getLabelInfo(block) {
    const { text } = block;
    const tokens = rules.beginRules.reference_definition.exec(text);
    let label = null;
    let info = null;
    if (tokens) {
...
exports.collectReferenceDefinitions = collectReferenceDefinitions;
