...
class MEHtmlBlockRenderer extends renderer.default {
    ...
    updatePreview(html) {
        if (!this.nodes.el) {
            ...
            this.nodes.el.appendChild(this.make('div', [classNames.CLASS_NAMES.ME_PREVIEW], {
                spellcheck: 'false',
                contenteditable: 'false'
            }));
            this.nodes.holder = this.make('pre', [classNames.CLASS_NAMES.ME_CONTAINER]);
            ...
            this.preview.appendChild(this.make('div', [classNames.CLASS_NAMES.ME_PREVIEW_CONTENT], {
                spellcheck: 'false',
                contenteditable: 'false'
            }));
...
module.exports = MEHtmlBlockRenderer;
