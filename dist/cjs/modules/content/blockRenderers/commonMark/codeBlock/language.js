...
class MELanguageRenderer extends renderer.default {
    ...
    updateContent() {
        if (!this.nodes.el) {
            this.nodes.el = this.make(this.tagName, [classNames.CLASS_NAMES.ME_EDITABLE, classNames.CLASS_NAMES.ME_LANGUAGE], { contenteditable: 'true', hint: this.t("Input code language") });
...
module.exports = MELanguageRenderer;
