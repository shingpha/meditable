...
function isUnindentableListItem() {
    const renderer = this;
...
function unindentListItem(type) {
    const renderer = this;
    const { block } = renderer;
    const listItem = block.parent;
    const list = listItem?.parent;
...
function checkCursorAtEndFormat() {
    const renderer = this;
    const cursor = renderer.getCursor();
    if (!cursor) {
        return null;
...
exports.checkCursorAtEndFormat = checkCursorAtEndFormat;
exports.indentListItem = indentListItem;
exports.insertTab = insertTab;
exports.isIndentableListItem = isIndentableListItem;
exports.isUnindentableListItem = isUnindentableListItem;
exports.unindentListItem = unindentListItem;
