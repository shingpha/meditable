...
function handleBackspaceInParagraph() {
    ...
    if (previousContentBlock.type === 'paragraph') {
        convert.convertIfNeeded.call(previousContentBlock.renderer, text);
    }
    return true;
}
...
exports.handleBackspaceInBlockQuote = handleBackspaceInBlockQuote;
exports.handleBackspaceInList = handleBackspaceInList;
exports.handleBackspaceInParagraph = handleBackspaceInParagraph;
