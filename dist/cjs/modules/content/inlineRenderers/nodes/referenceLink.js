...
class MEReferenceLink extends node {
    ...
    renderSelf(data) {
        ...
        if (!this.nodes.el) {
            ...
            this.nodes.holder = this.make(this.tagName, [classNames.CLASS_NAMES.ME_REFERENCE_LINK], { spellcheck: "false", target: "_blank", href: hyperlink, title }, dataset);
...
module.exports = MEReferenceLink;
