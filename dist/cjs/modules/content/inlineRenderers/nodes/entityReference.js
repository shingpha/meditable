...
class MEEntityReference extends node {
    ...
    renderSelf(data) {
        ...
        if (!this.nodes.el || this.nodes.el.childNodes.length !== 4) {
            this.nodes.el =
                this.nodes.el || this.make("span", [classNames.CLASS_NAMES.ME_NODE, "entity-reference"]);
            ...
            this.nodes.el.innerHTML =
                '<span class="' + classNames.CLASS_NAMES.ME_MARKER + '" spellcheck="false"></span>' +
                    '<span class="' + classNames.CLASS_NAMES.ME_MARKER + " " + classNames.CLASS_NAMES.ME_TEXT + '" spellcheck="false"></span>' +
                    '<span class="' + classNames.CLASS_NAMES.ME_MARKER + '" spellcheck="false"></span>';
...
module.exports = MEEntityReference;
