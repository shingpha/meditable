...
class MEHeader extends node {
    ...
    renderSelf(data) {
        if (!this.nodes.el) {
            ...
            this.nodes.el.innerHTML = `<span class="${classNames.CLASS_NAMES.ME_MARKER}"></span><span class="${classNames.CLASS_NAMES.MU_HEADER_SPACE}"></span>`;
