...
class MEAutoLinkExtension extends node {
    ...
    renderSelf(data) {
        ...
        if (!this.nodes.el) {
            ...
            this.nodes.holder = this.make(this.tagName, [classNames.CLASS_NAMES.ME_AUTO_LINK_EXTENSION], { spellcheck: "false", target: "_blank", href: hyperlink });
...
module.exports = MEAutoLinkExtension;
