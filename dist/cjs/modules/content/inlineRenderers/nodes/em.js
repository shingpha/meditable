...
class MEEm extends node {
    ...
    renderSelf(data) {
        if (!this.nodes.el) {
            ...
            this.nodes.el.innerHTML = `<span class="${classNames.CLASS_NAMES.ME_MARKER}">${data.marker}</span><span class="${classNames.CLASS_NAMES.ME_MARKER}">${data.marker}</span>`;
