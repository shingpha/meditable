...
class MEHtmlComment extends node {
    static type = "html_comment";
    renderSelf(data) {
        const { openTag } = data;
        if (!this.nodes.el) {
            this.nodes.el = this.make("span", [classNames.CLASS_NAMES.ME_NODE]);
            this.nodes.el.innerHTML = `<span class="${classNames.CLASS_NAMES.ME_FIXED_MARKER}" spellcheck="false">`;
