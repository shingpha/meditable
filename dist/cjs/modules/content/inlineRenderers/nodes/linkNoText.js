...
class MELinkNoText extends node {
    static type = "link_no_text";
    static tagName = "a";
    ...
    renderSelf(data) {
        ...
        if (!this.nodes.el) {
            ...
            this.nodes.el.innerHTML = `<span class="${classNames.CLASS_NAMES.ME_FIXED_MARKER}"><</span><span class="${classNames.CLASS_NAMES.ME_FIXED_MARKER}">></span>`;
