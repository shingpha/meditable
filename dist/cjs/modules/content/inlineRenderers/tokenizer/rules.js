...
const commonMarkRules = {
    ...
    html_escape: new RegExp(`^(${escapeCharacter.escapeCharacters.join("|")})`, "i"),
    soft_line_break: /^(\n)(?!\n)/,
    hard_line_break: /^( {2,})(\n)(?!\n)/,
    // patched math marker `$`
    backlash: /^(\\)([\\`*{}\[\]()#+\-.!_>~:\|\<\>$]{1})/,
...
const validateRules = rawValidateRules;

exports.beginRules = beginRules;
exports.commonMarkRules = commonMarkRules;
exports.endRules = endRules;
exports.gfmRules = gfmRules;
