...
import { getImageSrc, imageUtils, selectFiles } from '../../utils/image.js';
import { isValidAttribute } from '../../../../utils/dompurify.js';
import { getTextContent } from '../../utils/dom.js';
import { canCopyBlob, copyBlob, saveToDisk } from '../../../../utils/utils.js';
import { imgURLToBlob } from '../../../../utils/convert.js';

class MEHtmlImg extends MENode {
