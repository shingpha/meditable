 ...
 */
import { getOffsetOfParent, getTextContent } from './dom.js';
...
function findBlockByElement(el) {
    ...
    const blockEl = el.closest(`.${CLASS_NAMES.ME_BLOCK}`);
...
export { clearDropBlock, findActivedNodes, findBlockByElement, findDropBlock, findInlineNode };
