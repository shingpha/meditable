...
class MELayout extends MEModule {
    nodes = {};
    containerRectCache;
    ...
    async makeWithCommonMode() {
        this.makeEditor();
        this.nodes.zone = domUtils.make('div', CLASS_NAMES.MEUI_EDITOR_ZONE);
        this.nodes.editor.appendChild(this.nodes.zone);
        this.nodes.content = domUtils.make('div', [CLASS_NAMES.MEUI_EDITOR_CONTENT, CLASS_NAMES.ME_CONTENT]);
