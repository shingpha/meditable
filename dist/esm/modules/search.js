...
import { getFormatsInRange, clearFormat, addFormat } from './content/commands/format.js';
import { COMMAND_TYPE_MAP } from './content/commands/inline.js';
import { generator } from './content/inlineRenderers/tokenizer/index.js';
import { getOffsetOfParent, getNodeAndOffset, getTextContent } from './content/utils/dom.js';
import { findBlockByElement } from './content/utils/find.js';
...
function searchReplaceAction(editable, options, rng) {
    ...
    let markerNode;
    if (rng.startContainer.nodeType === 1 && (markerNode = rng.startContainer.closest(`.${CLASS_NAMES.ME_MARKER}`))) {
...
class MESearch extends MEModule {
    _resultList = [];
    _currentIndex = 0;
    _canvas;
    _holder;
