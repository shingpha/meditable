...
import { getOffsetOfParent, compareParagraphsOrder, getNodeAndOffset } from '../content/utils/dom.js';

class MESelection extends MEModule {
    _document;
    _root;
    _rootDocNode;
    _ranges;
        ...
        if (env.ie9below) ;
            ...
            if (sel && sel.rangeCount) {
                ...
                if (range.collapsed &&
                    ...
                    domUtils.isRoot(range.startContainer) &&
                    !range.startOffset) {
                    optimize(range);
                }
            }
